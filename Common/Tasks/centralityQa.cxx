...
struct CentralityQa {
  ...
  { 
    ...
    if (isRun2) {
      ...
      histos.add("hMultITSIBVsCentFV0A", "FV0A centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});
      histos.add("hMultITSIBVsCentFT0M", "FT0M centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});
      histos.add("hMultITSIBVsCentFT0A", "FT0A centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});
      histos.add("hMultITSIBVsCentFT0C", "FT0C centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});
      histos.add("hMultITSIBVsCentFT0CVar1", "FT0CVar1 centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});
      histos.add("hMultITSIBVsCentFT0CVar2", "FT0CVar2 centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});
      histos.add("hMultITSIBVsCentFDDM", "FDDM centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});
      histos.add("hMultITSIBVsCentNTPV", "NTPV centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});
      histos.add("hMultITSIBVsCentNGlobal", "NGlobal centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});
      histos.add("hMultITSIBVsCentMFT", "MFT centrality (%); Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {{nBins, 0, 105.}, axisMultiplicityITS});

      if (isMC) {
        histos.add("hMultITSIBVsGenMultFV0A", "Multiplicity FV0A; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
        histos.add("hMultITSIBVsGenMultFT0M", "Multiplicity FT0M; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
        histos.add("hMultITSIBVsGenMultFT0A", "Multiplicity FT0A; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
        histos.add("hMultITSIBVsGenMultFT0C", "Multiplicity FT0C; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
        histos.add("hMultITSIBVsGenMultFT0CVar1", "Multiplicity FT0CVar1; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
        histos.add("hMultITSIBVsGenMultFT0CVar2", "Multiplicity FT0CVar2; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
        histos.add("hMultITSIBVsGenMultFDDM", "Multiplicity FDDM; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
        histos.add("hMultITSIBVsGenMultNTPV", "Multiplicity NTPV; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
        histos.add("hMultITSIBVsGenMultNGlobal", "Multiplicity NGlobal; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
        histos.add("hMultITSIBVsGenMultMFT", "Multiplicity MFT; Multiplicity ITS Inner barrel (|#it{#eta}| < 1.5)", kTH2D, {axisMultiplicity, axisMultiplicityITS});
      }
    }
  ...
  void processRun3_FV0A(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentFV0As>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentFV0A"), col.centFV0A(), col.multNTracksPVetaHalf());
  }
  ...
  void processRun3_FT0M(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentFT0Ms>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentFT0M"), col.centFT0M(), col.multNTracksPVetaHalf());
  }
  ...
  void processRun3_FT0A(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentFT0As>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentFT0A"), col.centFT0A(), col.multNTracksPVetaHalf());
  }
  ...
  void processRun3_FT0C(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentFT0Cs>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentFT0C"), col.centFT0C(), col.multNTracksPVetaHalf());
  }
  ...
  void processRun3_FT0CVar1(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentFT0CVariant1s>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentFT0CVar1"), col.centFT0CVariant1(), col.multNTracksPVetaHalf());
  }
  ...
  void processRun3_FT0CVar2(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentFT0CVariant2s>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentFT0CVar2"), col.centFT0CVariant2(), col.multNTracksPVetaHalf());
  }
  ...
  void processRun3_FDDM(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentFDDMs>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentFDDM"), col.centFDDM(), col.multNTracksPVetaHalf());
  }
  ...
  void processRun3_NTPV(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentNTPVs>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentNTPV"), col.centNTPV(), col.multNTracksPVetaHalf());
  }
  ...
  void processRun3_NGlobal(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentNGlobals>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentNGlobal"), col.centNGlobal(), col.multNTracksPVetaHalf());
  }
  ...
  void processRun3_MFT(soa::Join<aod::Collisions, aod::EvSels, aod::Mults, aod::CentMFTs>::iterator const& col)
  {
    ...
    histos.fill(HIST("hMultITSIBVsCentMFT"), col.centMFT(), col.multNTracksPVetaHalf());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileFV0A"), col.centFV0A(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentFV0A"), col.centFV0A(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultFV0A"), mcCol.multMCFV0A(), col.multNTracksPV());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileFT0M"), col.centFT0M(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentFT0M"), col.centFT0M(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultFT0M"), mcCol.multMCFT0A()+mcCol.multMCFT0C(), col.multNTracksPV());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileFT0A"), col.centFT0A(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentFT0A"), col.centFT0A(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultFT0A"), mcCol.multMCFT0A(), col.multNTracksPV());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileFT0C"), col.centFT0C(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentFT0C"), col.centFT0C(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultFT0C"), mcCol.multMCFT0C(), col.multNTracksPV());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileFT0CVar1"), col.centFT0CVariant1(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentFT0CVar1"), col.centFT0CVariant1(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultFT0CVar1"), mcCol.multMCFT0C(), col.multNTracksPV());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileFT0CVar2"), col.centFT0CVariant2(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentFT0CVar2"), col.centFT0CVariant2(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultFT0CVar2"), mcCol.multMCFT0C(), col.multNTracksPV());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileFDDM"), col.centFDDM(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentFDDM"), col.centFDDM(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultFDDM"), mcCol.multMCFDDA()+mcCol.multMCFDDC(), col.multNTracksPV());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileNTPV"), col.centNTPV(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentFDDM"), col.centNTPV(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultFDDM"), mcCol.multMCITSIB(), col.multNTracksPV());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileNGlobal"), col.centNGlobal(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentNGlobal"), col.centNGlobal(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultNGlobal"), mcCol.multMCNParticlesEta08(), col.multNTracksPV());
  }
                                  ...
                                  soa::Join<aod::BCs, aod::Run3MatchedToBCSparse> const& /*bcs*/)
  {
    ...
    histos.fill(HIST("hCentProfileMFT"), col.centMFT(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsCentMFT"), col.centMFT(), col.multNTracksPVetaHalf());
    histos.fill(HIST("hMultITSIBVsGenMultMFT"), mcCol.multMCMFT(), col.multNTracksPV());
  }
