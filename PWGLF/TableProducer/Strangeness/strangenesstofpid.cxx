...
using TracksWithAllExtras = soa::Join<aod::TracksIU, aod::TracksExtra, aod::pidTPCFullEl, aod::pidTPCFullPi, aod::pidTPCFullKa, aod::pidTPCFullPr, aod::TOFEvTime, aod::TOFSignal>;
...
struct strangenesstofpid {
    ...
    if (doQA) {
      ...
      if (doQANSigma) {
        if (calculateV0s.value > 0) {
          ...
          histos.add("h2dNSigmaPositivePhotonEl", "h2dNSigmaPositivePhotonEl", {HistType::kTH2F, {axes.axisP, axes.axisNSigma}});
          histos.add("h2dNSigmaNegativePhotonEl", "h2dNSigmaNegativePhotonEl", {HistType::kTH2F, {axes.axisP, axes.axisNSigma}});
        }
  ...
  struct v0TofInfo { // holds processed information regarding TOF for V0s
    ...
    float deltaTimePositivePhotonEl = o2::aod::v0data::kNoTOFValue;
    float deltaTimeNegativePhotonEl = o2::aod::v0data::kNoTOFValue;
    ...
    float deltaDecayTimePhoton = o2::aod::v0data::kNoTOFValue;
    ...
    float betaPhoton = o2::aod::v0data::kNoTOFValue;
  };
  ...
  struct trackTofInfo { // holds input track info
    ...
    float tofEvTimeErr = 0.0f;
    float length = 0.0f;

    // save TPC PID here for completeness too
    float tpcNSigmaEl = 0.0f;
  ...
  v0TofInfo calculateTofInfoV0(TCollisions const& collisions, int const& collisionId, TV0 const& v0, TTOFInfo const& pTof, TTOFInfo const& nTof)
  {
    ...
    bool k0ShortCandidate = std::abs(v0.mK0Short() - o2::constants::physics::MassKaonNeutral) < v0Group.qaMassWindow &&
                            std::abs(pTof.tpcNSigmaPi) < v0Group.qaTPCNSigma &&
                            std::abs(nTof.tpcNSigmaPi) < v0Group.qaTPCNSigma;
    bool photonCandidate = std::abs(v0.mGamma() - o2::constants::physics::MassPhoton) < v0Group.qaMassWindow &&
                           std::abs(pTof.tpcNSigmaEl) < v0Group.qaTPCNSigma &&
                           std::abs(nTof.tpcNSigmaEl) < v0Group.qaTPCNSigma;
    ...
    if (pTof.hasTOF && pTof.tofEvTime > -1e+5 && pValidTOF) {
      ...
      if (calculationMethod.value == 1) {
        if (pTof.collisionId >= 0) {
          ...
          if (successPropag) {
            ...
            v0tof.timePositiveEl = o2::framework::pid::tof::MassToExpTime(pTof.tofExpMom, lengthPositive, o2::constants::physics::MassElectron * o2::constants::physics::MassElectron);
            ...
            // as primary
            v0tof.timeAsPrimaryPositiveEl = o2::framework::pid::tof::MassToExpTime(pTof.tofExpMom, pTof.length, o2::constants::physics::MassElectron * o2::constants::physics::MassElectron);
      ...
      if (lengthPositive > 0.0f) {
        v0tof.deltaTimePositivePhotonEl = (pTof.tofSignal - pTof.tofEvTime) - (v0tof.timePhoton + v0tof.timePositiveEl);
        ...
        if (useNsigmaCalibStrTOF) {
          ...
          if (nSigmaCalibLoaded) {
            v0tof.nSigmaPositivePhotonEl = -999.;
            ...
            v0tof.nSigmaPositivePhotonPi = -999.;
            v0tof.nSigmaPositivePhotonKa = -999.;
            v0tof.nSigmaPositivePhotonPr = -999.;
            v0tof.nSigmaPositiveLambdaEl = -999.;
            v0tof.nSigmaPositiveLambdaKa = -999.;
            v0tof.nSigmaPositiveK0ShortEl = -999.;
            v0tof.nSigmaPositiveK0ShortKa = -999.;
            v0tof.nSigmaPositiveK0ShortPr = -999.;
          }
        } else {
        ...
        if (doQA) {
          if (passesQAcuts) {
            ...
            if (photonCandidate) {
              if (doQANSigma && std::fabs(v0tof.nSigmaPositivePhotonEl - o2::aod::v0data::kNoTOFValue) > o2::aod::v0data::kEpsilon) {
                histos.fill(HIST("h2dNSigmaPositivePhotonEl"), v0.pt(), v0tof.nSigmaPositivePhotonEl);
              }
            }
          }
        }
    ...
    if (nTof.hasTOF && nTof.tofEvTime > -1e+5 && nValidTOF) {
      ...
      if (calculationMethod.value == 0) {
        ...
        v0tof.timeNegativeEl = lengthNegative / velocityNegativeEl;
      ...
      if (calculationMethod.value == 1) {
        if (nTof.collisionId >= 0) {
          ...
          if (successPropag) {
            ...
            v0tof.timeNegativeEl = o2::framework::pid::tof::MassToExpTime(nTof.tofExpMom, lengthNegative, o2::constants::physics::MassElectron * o2::constants::physics::MassElectron);
            ...
            // as primary
            v0tof.timeAsPrimaryNegativeEl = o2::framework::pid::tof::MassToExpTime(nTof.tofExpMom, nTof.length, o2::constants::physics::MassElectron * o2::constants::physics::MassElectron);
      ...
      if (lengthNegative > 0.0f) {
        v0tof.deltaTimeNegativePhotonEl = (nTof.tofSignal - nTof.tofEvTime) - (v0tof.timePhoton + v0tof.timeNegativeEl);
        ...
        if (useNsigmaCalibStrTOF) {
          // de facto nsigma
          if (nSigmaCalibLoaded) {
            v0tof.nSigmaNegativePhotonEl = -999.;
            ...
            // with wrong hypothesis
            v0tof.nSigmaNegativePhotonPi = -999.;
            v0tof.nSigmaNegativePhotonKa = -999.;
            v0tof.nSigmaNegativePhotonPr = -999.;
            v0tof.nSigmaNegativeLambdaEl = -999.;
            v0tof.nSigmaNegativeLambdaKa = -999.;
            v0tof.nSigmaNegativeK0ShortEl = -999.;
            v0tof.nSigmaNegativeK0ShortKa = -999.;
            v0tof.nSigmaNegativeK0ShortPr = -999.;
          }
        } else {
          // use nSigma function from O2Physics/Common/Core/PID/PIDTOFParamService.h
        ...
        if (doQA) {
          if (passesQAcuts) {
            ...
            if (photonCandidate) {
              if (doQANSigma && std::fabs(v0tof.nSigmaNegativePhotonEl - o2::aod::v0data::kNoTOFValue) > o2::aod::v0data::kEpsilon) {
                histos.fill(HIST("h2dNSigmaNegativePhotonEl"), v0.pt(), v0tof.nSigmaNegativePhotonEl);
              }
            }
          }
        }
      ...
      if (nTof.hasTOF && pTof.hasTOF) { // does not depend on event time
        ...
        float decayTimePhoton = 0.5f * ((pTof.tofSignal - v0tof.timePositiveEl) + (nTof.tofSignal - v0tof.timeNegativeEl)) - evTimeMean;
        ...
        v0tof.betaPhoton = (lengthV0 / decayTimePhoton) / lightSpeed;
